(function ( $ ) {
	...
	$(document).on('click','.toggler', function(){
		...
		doAnimation(container, containerWidth, side, status, modalBody);
	});
...
//esegue l'animazione
function doAnimation(container, containerWidth, sidebarSide, sidebarStatus, modalBody){
	...
	if(sidebarStatus=="opened"){
		...
		if(sidebarSide=="left"){
			...
			modalBody.animate({
				'padding-left' : containerWidth +15
				});
			toggleArrow(toggler, "right");
		}else if(sidebarSide=="right"){
			container.animate({
			...
			modalBody.animate({
				'padding-right' : containerWidth +15
				});
			toggleArrow(toggler, "left");
		}
