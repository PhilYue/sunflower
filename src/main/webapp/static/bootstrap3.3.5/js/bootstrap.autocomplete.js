! function ($) {
    ...
    var Autocomplete = function (element, options) {
        ...
        this.select_callback = this.options.select_callback || this.select_callback
        this.blur_callback = this.options.blur_callback || this.blur_callback
    ...
    Autocomplete.prototype = {
            ...
            formatItem: function (item) {
                ...
                this.select_callback(val,realVal,this.$element)
                return this.hide()
                ...
                this.$element.on('click',$.proxy(this.input_click, this));
                ...
                this.blur_callback(this.$menu,this.$element)
            }, click: function (e) {
                e.stopPropagation()
                e.preventDefault()
                this.select()
            ...
            }, blur_callback: function($menu,$element){
