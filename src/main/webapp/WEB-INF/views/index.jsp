...
<head>
    ...
    <link href="/static/css/style.min.css?v=3.2.0" rel="stylesheet">
</head>
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="/static/img/profile_new.png" /></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="index.html#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">Phil</strong></span>
                    ...
                    <div class="logo-element">Jasmine
                    </div>
                </li>
                <!-- 主页 -->
                <li>
                    <a class="J_menuItem" href="mainPage.html"><i class="fa fa-home"></i> <span class="nav-label">主页</span></a>
                </li>
                <%-- <li>
                    <a href="index.html#">
                ...
                <!-- 任务系统 -->
                <li>
                    <a href="index.html#"><i class="fa fa-edit"></i> <span class="nav-label">抓取主任务</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="javascript:;">视频任务列表 <span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li><a class="J_menuItem" href="mainTask.html">评论抓取任务列表</a>
                                </li>
                                <li><a class="J_menuItem" href="mainTask.html">弹幕抓取任务列表</a>
                                </li>
                            </ul>
                        </li>
                        <li><a class="J_menuItem" href="form_basic.html">搜索任务列表</a>
                        </li>
                    </ul>
                </li>
                <!-- 主任务系统 -->
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <%--<ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="hidden-xs">
                        <a href="mainPage.html" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a>
                    </li>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="mainPage.html">首页</a>
                </div>
            </nav>
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="mainPage.html" frameborder="0" data-id="mainPage.html" seamless></iframe>
        </div>
        <div class="footer">
