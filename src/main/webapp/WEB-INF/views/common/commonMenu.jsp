...
<div class="left-side sticky-left-side">
    ...
    <div class="logo">
        <a href="index.htm"><img src="../../static/images/logo.png" alt=""></a>
    </div>

    <div class="logo-icon text-center">
        <a href="index.htm"><img src="../../static/images/logo_icon.png" alt=""></a>
    </div>
    ...
    <div class="left-side-inner">
        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
            ...
            <!-- task page list -->
            <li class="menu-list"><a href="#"><i class="fa fa-th-list"></i> <span>任务(TASK)清单</span></a>
                <ul class="sub-menu-list">
                    <li><a href="/videotasks" > 视频任务列表 </a></li>
                    <li><a href="/tasks"> 视频搜索列表 </a></li>
                </ul>
            </li>
            <li class="menu-list"><a href=""><i class="fa fa-bar-chart-o"></i> <span>Charts</span></a>
                <ul class="sub-menu-list">
                    <li><a href="analyeBarrage.htm"> Barrage Charts</a></li>
